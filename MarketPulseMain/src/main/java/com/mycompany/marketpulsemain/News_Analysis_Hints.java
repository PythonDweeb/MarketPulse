 ...
 * @author kraj200
 */
public class News_Analysis_Hints extends javax.swing.JFrame {

    /**
     * Creates new form News_Analysis_Hints
     */
    public News_Analysis_Hints() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Title.setText("News, Analysis, and Hints");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(News_Analysis_Hints.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new News_Analysis_Hints().setVisible(true);
            }
        });
    }
